...
- 会話ウィンドウを表示
  - 画面
    - ウィンドウ背景：青色
    - ウィンドウ枠：金色
    - 背景：assets/img/character/hero/hero_fullbody.png を全画面に固定表示（透明度60%、オーバーレイ演出は既存と同条件）
  ...
  - カタカナを横書きで並べてある
    ...
    - レイアウト
      ...
      - 文字
        ...
        - レイアウトは５文字ずつ揃える
  - 背景画像
    - 名前入力モードでは assets/img/character/hero/hero_fullbody.png を背景に固定表示する（オープニングと共通）
      - 透明度：60%
