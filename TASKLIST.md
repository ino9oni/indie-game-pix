...
- [d―ne] ~~オープニング画面で、NewGameを行ったときに、「削除してよろしいですか」の確認を削除する~~
...
- デバッグモードの追加
  ...
  - 効果
    　- デバッグモードオンの場合
        - ピクロスの進行状況に関係なく、Submitをした後、ゲームクリアの判定になる
      - デバッグモードオフの場合
...
- 会話ウィンドウの変更
  - 表示
    - 会話ウィンドウの表示位置を画面の中央より下段に配置
    - 敵キャラクターの表示位置を画面右へ配置
    - 主人公の表示位置を画面左へ配置
- ピクロスの表示の変更
  - ピクロスの縦横が小さいので、画面の高さ全体に拡大
  - 文字やヒントの数字についても、ピクロスの縦横にあわせて拡大
