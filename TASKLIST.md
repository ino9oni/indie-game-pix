...
- [done] ピクロスモード時の全ENEMYのピクロスボードサイズを５ｘ５に変更
  - 背景：
    - お題のサイズが10x10等になると急に時間がかかり始めてしまい、スピード感、爽快感が少なくなる
    - そのため小さいサイズの物を素早く説いていくスピード感、爽快感を重視する
  - 

- ピクロスモードのお題の記号化
  - 背景：
    - お題を意味不明な形にするのではなく、記号的形及び文字的な意味を与えて、最終的にそれらを収集して、Endingを迎えるというストーリーに結節したい
  - 変更内容：
    - PRACTICE,EASY,MIDDLE,HARD,ULTRAの各出題されるお題は
