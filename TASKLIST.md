...
　- 作成日
  ...
  - 不具合の重要度
    ...
    - 発生頻度：小中大（理由：）
## Priority: high
- 勝利モードのピクロスの並びが10x10に対応できておらず表示が崩れている
　- 作成日
    2025/11/03
  - 事象・問題点・仕様と異なる点
  ...
  - 改修案、改修例を記載
    ...
    - 10x10のスロットはサイズが違う以外は5x5と同じ扱い（アンロックすればNewで色を変更して表示する）とする
  - 不具合の重要度
...
- ピクロスのお題の難化
  ...
  - 変更後の仕様：
    - 仕様１
      - ボードのサイズに対して、高々１つの最大数のヒントとする
      - 上記以外の行列は、可能な限り小さい数のヒントとする
      - その上で、SOLVERで解が一つになるようにする
